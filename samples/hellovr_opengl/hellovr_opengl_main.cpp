...
bool CMainApplication::BInit()
{
	...
	// m_pCompanionWindow = HMDに写っている映像のpreviewを出す機能説 = 多分True
	...
	// GLEWの初期化、OpenGLの拡張機能。シェーダとかも含まれているらしい。
	// TODO: GLEWの詳細
	...
	std::string strWindowTitle = "hellovr - " + m_strDriver + " " + m_strDisplay + " - taishi eguchi";
	...
	// TODO: Actionsファイルが何を設定するものなのかを調べる。
	// OpenVR: https://github.com/ValveSoftware/openvr/wiki/Action-manifest
...
bool CMainApplication::CreateAllShaders()
{
	...
	// すべて成功したらTrue
	return m_unSceneProgramID != 0 && m_unControllerTransformProgramID != 0 && m_unRenderModelProgramID != 0 && m_unCompanionWindowProgramID != 0;
}
